...
class SonarrCli(BaseCliMediaApi):
    ...
    def add_serie(
        ...
        if tvdb_id:
            serie_info = cast(
                SonarrSerieItem, self.lookup_serie(tvdb_id=tvdb_id))
        if not serie_info:
            raise SonarrCliError(
                "Error, invalid parameters or invalid tvdb id")
    ...
    def get_episode(
        ...
        """
        if serie_id:
            res = self.request_get(self.api_url_episode, url_params={
                                   "seriesId": serie_id})
        elif episode_id:
    ...
    def get_episode_file(
        ...
        """
        if serie_id:
            res = self.request_get(self.api_url_episodefile, url_params={
                                   "seriesId": serie_id})
        elif episode_id:
